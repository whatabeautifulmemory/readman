...
- **Continuous capture** — the viewfinder stays open with a card-shaped frame (landscape or portrait, for 縦型 cards); shoot card after card, only the framed area is kept. Or pick up to 50 photos from the gallery.
...
- English · 한국어 · 日本語 (switchable in Settings), dark mode, Android 9+.
